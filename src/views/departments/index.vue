<template>
    <div class="departments-page">
        <PageHeader title="部門管理">
            <template #action>
                <IconBtn v-if="isAdmin" icon="PLUS" label="新增部門" class="btn-primary" @click="handleAdd" />
            </template>
        </PageHeader>

        <DepartmentTable :departments="departmentStore.departments" :is-admin="isAdmin" @edit="handleEdit"
        ...
        <!-- 部門 Modal -->
        <DepartmentModal v-model="showDepartmentModal" :department="selectedDepartment"
